...
“TINY WARDROBE”는 단순한 스타일 제안을 넘어, 부모들이 자신들의 취향과 기준에 맞는 제품을 더욱 쉽게 선택할 수 있도록 돕는 가이드형 매거진을 지향한다. 유아 패션 트렌드 분석, 브랜드 소개, 가격대 비교 등 다양한 콘텐츠를 통해 소비자들에게 실질적인 정보를 제공한다.`,
    images: [
      '/images/works-optimized/media-production/1/1.webp',
      '/images/works-optimized/media-production/1/2.webp',
      '/images/works-optimized/media-production/1/3.webp',
    ],
  },
  {
    id: 2,
    ...
    images: [
      '/images/works-optimized/media-production/2/1.webp',
      '/images/works-optimized/media-production/2/2.webp',
      '/images/works-optimized/media-production/2/3.webp',
      '/images/works-optimized/media-production/2/4.webp',
    ],
  },
  {
    id: 3,
    ...
    images: [
      '/images/works-optimized/media-production/3/1.webp',
      '/images/works-optimized/media-production/3/2.webp',
      '/images/works-optimized/media-production/3/3.webp',
      '/images/works-optimized/media-production/3/4.webp',
    ],
  },
  {
    id: 4,
    ...
    images: ['/images/works-optimized/media-production/4/1.webp'],
  },
  {
    id: 5,
    title: 'wearing time',
...
경험을 담는 매개체로 바라보고자 한다`,
    images: [
      '/images/works-optimized/media-production/5/1.webp',
      '/images/works-optimized/media-production/5/2.webp',
      '/images/works-optimized/media-production/5/3.webp',
      '/images/works-optimized/media-production/5/4.webp',
      '/images/works-optimized/media-production/5/5.webp',
    ],
  },
  {
    id: 6,
