...
export const BRANDING_WORKS: Work[] = [
  {
    id: 1,
    title: 'IONNE',
    artist: '김아영',
  ...
  },
  {
    ...
    title: 'eeom',
    artist: '이나연',
    description: `아드레날린이 솟구치는 열정적인 순간 피부에 닿는
서늘한 여름의 감각 두 에너지가 교차하는 찰나를 위한 디자인을합니다.
자신만의 궤도를 개척해 나가는 모든 이들의 일상에 스며드는
새로운 룩을 제안하는 Contemporary Active 여성복 브랜드.

끊임없는 자신에 대한 탐구는 결국 문화와 연결됩니다.

자신에 대한 탐구를 기반으로고유한 한국만의 문화적 아카이브에서 영감을 받아
현대적인 디자인으로 재해석하고, 디자이너의 다양한 문화적 경험을 바탕으로, 전통과 현대,
문화와 개인의 경험이 교차하는 지점에서 브랜드의 디자인 언어를 만들어갑니다.
더 나아가 20대가 느끼는 문화적 고유성과 일상의 거리감을 좁히고,
브랜드는 지속적으로 새로운 문화적 아카이브을 쌓아갑니다.`,
    images: [
...
도시의 무채색을 뒤로하고 자연의 생명력을 마주하는 순간,
오직 당신의 호흡과 발걸음이 만드는 리듬에만 집중하세요.
VIVID ALIEN은 당신이 자연 속에 동화되는 트래블 러닝의 모든 순간을 응원합니다.
...
- 그 외 구성 : Sleeveless, Half Tights, Trail cap (변동 가능)`,
  ...
  },
  {
    ...
    title: 'D.Woorks',
    artist: '정하두',
    description: `D.WooRKS는 변화하는 업무 환경 속에서, 단정함과 실용성의 균형을 재설계하는 브랜드입니다.

전통 워크웨어의 기능적 요소를 현대 도시 직장인의 복장에 적용해, 외형 중심의 옷에 실용성과 역할의 의미를 다시 부여합니다.
...
D.WooRKS 옷은 과장된 장식이 아닌, 기능에서 비롯된 디테일과 절제된 표현을 통해 완성됩니다.`,
  ...
  },
  {
    ...
    title: 'INLET (인렛)',
    artist: '한정효',
    description: `INLET은 바깥의 자극에서 벗어나 안으로 들어오는 순간을 담은 프리미엄 라운지웨어 브랜드입니다.
...
그 안에서, 나만의 고요한 안식의 섬을 마주하게 됩니다.`,
    images: [
      ...
      '/images/works-optimized/branding/7/5.webp',
    ],
  },
];
